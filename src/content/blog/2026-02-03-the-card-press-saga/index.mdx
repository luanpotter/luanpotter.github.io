...
> For a step-by-step tutorial on how to execute the print-then-cut pipeline with the Cricut and card-press, check out [Print & Play with Cricut](/articles/print-and-play-with-cricut).
